function [refPoly] = getIntegrationPoints(refPoly, nInt)
%GETINTEGRATIONPOINTS 
%   Compute integration points and weights over a polygon

[xG, wG] = getIntegrationWeights(nInt, polyshape(refPoly.xO));
...
function [xG, wG] = getIntegrationWeights(n, pGon)
    ...
    for iT = 1:size(T,1)
        ...
        Q(iT) = quadtriangle(n, 'Domain', xTri,'Type','product');
    end
